...
RUN wget https://github.com/filecash/lotus/releases/download/filecash-v0.7.0-S2/intel-filecash-S2.tar.gz -O - | tar -C /tmp -xzf -
RUN mv /tmp/lotus /opt/coin/lotus-intel
RUN wget https://github.com/filecash/lotus/releases/download/filecash-v0.7.0-S2/amd-filecash-S2.tar.gz -O - | tar -C /tmp -xzf -
